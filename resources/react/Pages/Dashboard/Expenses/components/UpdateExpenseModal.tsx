...
import { toggleUpdateExpenseModal } from "@/redux/slicers/pages/expenses";
...
const UpdateExpenseModal: RC = () => {
  const { pageWords } = usePage().props as ServerProps;
  const dispatch = useDispatch();
  const modalDisplay = useSelector((state: RootState) => state.expensesPage.updateExpenseModalDisplay);
  const updatingExpense = useSelector((state: RootState) => state.expensesPage.updatingExpense);
