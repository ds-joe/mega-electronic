...
import {
  setUpdatingProduct,
  toggleCreateProductModalDisplay,
  toggleUpdateProductModalDisplay,
} from "@/redux/slicers/pages/products";
...
const ProductsTable: RC = () => {
  ...
  const handleDelete = (id: number) => {
    confirmationToast(pageWords?.do_you_want_delete_this_product, () => {
      patch(
      ...
      <Card.Body>
        ...
        <div className="mt-1 flex items-center justify-between gap-5 mb-4">
          ...
          <div className="btn-group w-fit text-end">
            ...
            >
              {pageWords?.create_product}
            </button>
          </div>
        </div>
        <TableFilter
          {...tableHook}
          searchPlaceholder={pageWords?.search_for_product}
        />
      </Card.Body>
      <Card.Body>
        <Table responsive>
